...
<center>
           ...
           <a href="add_planD.php" class="btn btn-primary"><?= __('Add New')?></a>&nbsp&nbsp&nbsp&nbsp
		   <a href="codingstudio_data_downloadplan.php" class="btn btn-primary" target="_blank"><?= __('Data Export')?></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
           <a href="indexuplod.php" class="btn btn-primary"><?= __('UPlode')?></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		    <a href="home.php"class="btn btn-primary"><?= __('Home')?></a>
			 <a href="printpdf.php"class="btn btn-primary"><?= __('Export PDF')?></a>
         </div>
        </div>
...
<?= __('Edit')?>-<input type='checkbox' id='EditAll' autocomplete="off" >
 ...
 <div class="col-sm-6" id="dalete_div"><br>
