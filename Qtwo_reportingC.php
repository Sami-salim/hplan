...
include "db_conn.php";   
                         ...
                         (`quartertwo`) as uptoqtwo_plan, (`quartertwo_report`) as uptoqtwo_report, 
                         FORMAT(((`quartertwo_report`)*100)/(`quartertwo`),2) as uptoqtwo_achiv, FORMAT((`quartertwo_report`*100)/(`quartertwo`),2) as quartertwo_achiv
...
<head>
 ...
 <meta charset="utf-8">
 <title>Quartertwo_reportingC</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <!-- Bootstrap CSS -->
...
<div class="col-sm-12">
  ...
  <h3 align="center" ><?php echo $_REQUEST['msg']; ?></h3>
   <br />   
<form action="editquarter2C.php" method="post">
