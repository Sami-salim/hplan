...
<div class="col-sm-12">
   ...
   <br />   
<form action="editquarter1C.php" method="post">
...
<div class="col-sm-5" id="edit_div" style="margin-left: -53px;">
     ...
     <th width="2%" align="center"><?= __('Sl No')?></a></th><div>
      <th width="20%" align="center"><?= __('Indicatore')?></a></th><div>
       <th width="10%" align="center"><?= __('unit')?></a></th><div>
		...
		<th width="20%" align="center"><?= __('year')?></th>
        <th width="15%
...
<div class="text-center">
  <a href="codingstudio_data_download.php" class="btn btn-primary" target="_blank">Data Export</a>
