...
include "db_conn.php";   
                         ...
                         (`quarterthree`) as uptoqthree_plan, (`quarterthree_report`) as uptoqthree_report, 
                         FORMAT(((`quarterthree_report`)*100)/(`quarterthree`),2) as uptoqthree_achiv, FORMAT((`quarterthree_report`*100)/(`quarterthree`),2) as quarterthree_achiv
...
<head>
 ...
 <meta charset="utf-8">
 <title>Quarterthree_reporting</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <!-- Bootstrap CSS -->
...
<div class="col-sm-12">
   ...
   <br />   
<form action="editquarter3C.php" method="post">
