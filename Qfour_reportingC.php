...
include "db_conn.php";   
                         ...
                         (`quarterfour`) as uptoqfour_plan, (`quarterfour_report`) as uptoqfour_report, 
                         FORMAT(((`quarterfour_report`)*100)/(`quarterfour`),2) as uptoqfour_achiv, FORMAT((`quarterfour_report`*100)/(`quarterfour`),2) as quarterfour_achiv
...
<div class="col-sm-12">
   ...
   <br />   
<form action="editquarter4C.php" method="post">
