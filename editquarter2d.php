...
if($totaldeleteid==""){
echo "<script>alert('Sorry No Record Found');window.location.href = 'Qtwo_reportingd.php';</script>";exit;
}
...
header("Location:Qtwo_reportingd.php?msg=Update Successfully");  
}
...
<tr>
    <td>
<h3>TOTAL EDIT IDS "<?php echo $totaledit_ids; if($totaledit_ids==""){echo "<script>alert('Sorry No Record Found');window.location.href = 'Qtwo_reporting.php';</script>";}?>"</h3>
...
<form action="editquarter2d.php" method="post" autocomplete="off">
<?php
$j = 0;
