...
if($totaldeleteid==""){
echo "<script>alert('Sorry No Record Found'); window.location.href = 'Qthree_reportingC.php';</script>";exit;
}
...
header("Location:Qthree_reportingC.php?msg=Update Successfully");  
}
...
<head>
  <meta charset="utf-8">
   <title>Qthree_reporting_C</title>
...
<form action="editquarter3C.php" method="post" autocomplete="off">
<?php
$j = 0;
